...
This is a template repo for code based projects in PHW. 
...
It is mainly designed for Python projects, but can be used for other code projects (such as R projects).

To set up a new repo using the template, you must have Python installed.
...
Sets up a repo with:
  ...
  - Issue, pull request templates and release management for use on GitHub 
